...
router.post("/signup", middleware("guest"), sanitizeAndValidate(authValidation.signup), control(authController.signup));
router.post("/signin", middleware("guest"), sanitizeAndValidate(authValidation.signin), control(authController.signin));
...
router.patch("/verify-email/:token", sanitizeAndValidate(authValidation.verifyEmail), control(authController.verifyEmail));
router.get("/forgot-password", sanitizeAndValidate(authValidation.forgotPassword), control(authController.forgotPassword));
router.patch("/reset-passowrd/:token", sanitizeAndValidate(authValidation.resetPassword), control(authController.passwordReset));
